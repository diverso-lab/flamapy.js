...
class Flamapy {
    ...
    async conflicDetection() {
        return this.runFlamapyMethod("PySATConflictDetection", this.fileContent,[], {}, TYPE_SOLVING.PYSATDIAGNOSIS);
     ...
     */
    async sampling() {
        return this.runFlamapyMethod("Sampling", this.fileContent,[], {}, TYPE_SOLVING.PYSAT);
    }
