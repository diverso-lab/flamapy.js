...
class Flamapy {
     ...
     */
    async configurations(bdd=false) {
        if (bdd)
            return this.runFlamapyMethod("BDDConfigurations", this.fileContent,[], {}, 1);
        else
     ...
     */
    async configurationsNumber(bdd=false) {
        if (bdd)
            return this.runFlamapyMethod("BDDConfigurationsNumber", this.fileContent,[], {}, 1);
        else
    ...
    async uniqueFeatures() {
        return this.runFlamapyMethod("BDDUniqueFeatures", this.fileContent, [], {}, 1);
    }
     ...
     */
    async runFlamapyMethod(operation, fileContent, args = [], kwargs = {}, type = 0) {
        try {
            if (this.options.DEBUG)
